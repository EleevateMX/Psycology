...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-violet-50 via-white to-white pt-16 pb-20">
      {/* Decorative blobs */}
      <div className="absolute top-0 right-0 w-72 h-72 bg-violet-100 rounded-full opacity-40 translate-x-24 -translate-y-12 blur-3xl" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-violet-50 rounded-full opacity-60 -translate-x-16 translate-y-8 blur-2xl" />
      <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-orange-50 rounded-full opacity-30 blur-3xl" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-violet-50 border border-violet-100 rounded-full text-violet-700 text-sm font-medium mb-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-4 text-balance">
            ...
            <span className="text-violet-700">ideal para ti</span>
          </h1>
