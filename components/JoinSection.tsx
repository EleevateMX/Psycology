...
export default function JoinSection() {
  return (
    <section id="para-psicologos" className="py-20 bg-gradient-to-br from-violet-700 to-violet-800">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-white">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">
              ¿Eres psicólogo?{' '}
              <span className="text-violet-300">Únete a Psique</span>
            </h2>
            ...
            <p className="text-violet-200 text-sm">Ya somos más de 200 psicólogos en Mérida y México</p>
          </div>
